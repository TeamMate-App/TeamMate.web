              ...
              <div className="card text-center w-100">
                <div className="row info">
                  <div className="title-user-profile">
                    <p class="espace-user text-right"><strong><svg xmlns="http://www.w3.org/2000/svg" 
                    viewBox="-1.5 -1.5 24 24" width="24" height="24" preserveAspectRatio="xMinYMin" class="icon__icon">
                    ...
                    <p class="espace-user text-right"><strong><svg xmlns="http://www.w3.org/2000/svg" 
                    viewBox="-2 -2 24 24" width="24" height="24" preserveAspectRatio="xMinYMin" class="icon__icon">
                    ...
                    <p class="espace-user text-right"><strong><svg xmlns="http://www.w3.org/2000/svg" 
                    viewBox="-2 -3 24 24" width="24" height="24" preserveAspectRatio="xMinYMin" class="icon__icon">
