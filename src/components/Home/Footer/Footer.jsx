...
const Footer = () => {
  return (
    <div className=" p-0">
      <footer
        className=" bg-footer text-center text-lg-start border mt-xl-5 pt-4"
        style={{ backgroundColor: "#11111d", color: "white" }}
      >
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
              ...
              <ul className="list-unstyled">
                <li>
                  <a
                    href="https://mountainmadnesss.herokuapp.com/"
            ...
            <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
              ...
              <div className="htmlForm-outline htmlForm-white mb-4">
                <input
                  type="email"
                  id="htmlForm5Example2"
                  className="htmlForm-control"
                />
                <label className="htmlForm-label" htmlFor="htmlForm5Example2">
                  Email address
                </label>
              </div>
            </div>
